<html>
    <head>
        ...
        <style>
            ...
            img{height:100px;margin-left:1200px;position:fixed}
            body{
                color: #12192b; 
                text-align: center; 
            ...
            #arrow{margin-top:150px;margin-left:350px}
            h1{
                text-align: center;
                font-family:Georgia;
                color:#fff12e;
            ...
            #span{color:#7FFFD4;
                ...
                margin:20px}
            /*form {position:fixed;}*/
            /*#forms{position:fixed}*/
            #div2{display:flex;}
            #forms{position:sticky;top:100px;}
            #all{
                background-color: #12192b;
                color: #fff12e;
                margin: 20px;
            ...
            @media (max-width:600px){
                #div0{margin-top:180px}
            }
        </style>
    </head>
<div id="heading">
<h1> 
    Schools and Workshops in Ergodic Theory
</h1>
<img src="ergodic theory(4).png">
</div>
<body>
...
$sql = "SELECT *, DATE_FORMAT(`start-date`, '%a, %e %M %Y') AS new_start_date, DATE_FORMAT(`end-date`, '%a, %e %M %Y') AS new_end_date FROM `conferencess` ORDER BY `start-date`";
$query= mysqli_query($conn, $sql);

?>
<i class="fa-solid fa-arrow-right" id="arrow"><p>please scroll right for more events.</p></i>
...
<form id="all" action= "submit.php" method= "post" >
    <button id="allbutton" type="submit" value="Submit" >
    Submit an event</button>
</form>
</div>
</div>

<p> designed and developed by Francesca Luzzatto <br><br> <a href="mailto:flwebdesignanddevelopment@gmail.com">flwebdesignanddevelopment@gmail.com</a><br> For any changes or edits to the list, please write to this email address.</p>
