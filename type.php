...
if ($filterbytype == "a") {
    echo "<p class = 'p0'> Schools in Ergodic Theory.</p>";
    $sql = "SELECT *, DATE_FORMAT(`start-date`, '%a, %e %M %Y') AS new_start_date, DATE_FORMAT(`end-date`, '%a, %e %M %Y') AS new_end_date  FROM conferencess WHERE type= 'a'";
    $query= mysqli_query($conn, $sql);
    ?>
    <div id = "div0">
    <?php
    ...
    <?php
  } elseif ($filterbytype == "b") {
    echo "<p class = 'p0'> Workshops in Ergodic Theory.</p>";
    $sql = "SELECT *, DATE_FORMAT(`start-date`, '%a, %e %M %Y') AS new_start_date, DATE_FORMAT(`end-date`, '%a, %e %M %Y') AS new_end_date  FROM conferencess WHERE type= 'b'";
    $query= mysqli_query($conn, $sql);
    ?>
    <div id = "div0">
    <?php
    ...
    <?php
  } elseif ($filterbytype == "c") {
    echo "<p class= 'p0'> Schools and Workshops in Ergodic Theory.</p>";
    $sql = "SELECT *, DATE_FORMAT(`start-date`, '%a, %e %M %Y') AS new_start_date, DATE_FORMAT(`end-date`, '%a, %e %M %Y') AS new_end_date  FROM conferencess WHERE type= 'c'";
    $query= mysqli_query($conn, $sql);
    ?>
    <div id = "div0">
    <?php
